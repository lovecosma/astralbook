...
Category.create(title: "Metals")
Category.create(title: "Angels")

Intention.create(name: "abundance")
Intention.create(name: "acceptance")
Intention.create(name: "accomplishment")
Intention.create(name: "action")
Intention.create(name: "activate / awaken")
Intention.create(name: "adaptability")
Intention.create(name: "affection")
Intention.create(name: "the afterlife")
Intention.create(name: "aggression")
Intention.create(name: "agriculture")
Intention.create(name: "ambition")
Intention.create(name: "anger")
Intention.create(name: "animals")
Intention.create(name: "anxiety")
Intention.create(name: "assertiveness")
Intention.create(name: "astral realm")
Intention.create(name: "attachments")
Intention.create(name: "attraction")
Intention.create(name: "authority")
Intention.create(name: "awareness")
Intention.create(name: "balance")
Intention.create(name: "banish")
Intention.create(name: "beauty")
Intention.create(name: "beginnings")
Intention.create(name: "bind")
Intention.create(name: "blessings")
Intention.create(name: "business")
Intention.create(name: "calm")
Intention.create(name: "challenges")
Intention.create(name: "change/s")
Intention.create(name: "charity")
Intention.create(name: "cheerfulness")
Intention.create(name: "clairaudience")
Intention.create(name: "clairvoyance")
Intention.create(name: "clarity")
Intention.create(name: "communication")
Intention.create(name: "community")
Intention.create(name: "compassion")
Intention.create(name: "concentration / focus")
Intention.create(name: "confidence")
Intention.create(name: "connections")
Intention.create(name: "consecrate / bless")
Intention.create(name: "consciousness")
Intention.create(name: "courage")
Intention.create(name: "crossroads")
Intention.create(name: "cunning")
Intention.create(name: "cycles")
Intention.create(name: "danger")
Intention.create(name: "darkness")
Intention.create(name: "death")
Intention.create(name: "dedication / devotion")
Intention.create(name: "defense")
Intention.create(name: "desire ")
Intention.create(name: "destiny")
Intention.create(name: "destruction")
Intention.create(name: "determination")
Intention.create(name: "dignity")
Intention.create(name: "discipline")
Intention.create(name: "divination")
Intention.create(name: "dream work")
Intention.create(name: "emotions")
Intention.create(name: "empathy")
Intention.create(name: "empowerment")
Intention.create(name: "enchantment")
Intention.create(name: "encouragement")
Intention.create(name: "endings")
Intention.create(name: "endurance")
Intention.create(name: "energy")
Intention.create(name: "enlightenment")
Intention.create(name: "enmity")
Intention.create(name: "fairness")
Intention.create(name: "faith")
Intention.create(name: "fame")
Intention.create(name: "family")
Intention.create(name: "fear")
Intention.create(name: "fertility")
Intention.create(name: "fidelity")
Intention.create(name: "forgiveness")
Intention.create(name: "freedom")
Intention.create(name: "friend/ship")
Intention.create(name: "generosity")
Intention.create(name: "goodness")
Intention.create(name: "grace")
Intention.create(name: "gratitude")
Intention.create(name: "grief")
Intention.create(name: "grounding")
Intention.create(name: "growth")
Intention.create(name: "guardian")
Intention.create(name: "harmony")
Intention.create(name: "healing")
Intention.create(name: "heartbreak")
Intention.create(name: "hexes")
Intention.create(name: "the home")
Intention.create(name: "honesty")
Intention.create(name: "honor")
Intention.create(name: "hope")
Intention.create(name: "illumination")
Intention.create(name: "imagination")
Intention.create(name: "improvement ")
Intention.create(name: "increase")
Intention.create(name: "innocence")
Intention.create(name: "insight")
Intention.create(name: "inspiration")
Intention.create(name: "integrity")
Intention.create(name: "introspection")
Intention.create(name: "jealousy")
Intention.create(name: "justice")
Intention.create(name: "karma")
Intention.create(name: "kindness")
Intention.create(name: "knowledge")
Intention.create(name: "life")
Intention.create(name: "light")
Intention.create(name: "limitations / boundaries")
Intention.create(name: "loss")
Intention.create(name: "love")
Intention.create(name: "loyalty")
Intention.create(name: "luck")
Intention.create(name: "lust")
Intention.create(name: "magic")
Intention.create(name: "manifestation")
Intention.create(name: "marriage")
Intention.create(name: "memory / memories")
Intention.create(name: "messages / omens")
Intention.create(name: "the mind")
Intention.create(name: "mindfulness")
Intention.create(name: "money")
Intention.create(name: "motivation")
Intention.create(name: "needs")
Intention.create(name: "negativity")
Intention.create(name: "nightmares")
Intention.create(name: "nurture")
Intention.create(name: "obstacles")
Intention.create(name: "order / organize")
Intention.create(name: "the otherworld / underworld")
Intention.create(name: "passion")
Intention.create(name: "patience")
Intention.create(name: "peace")
Intention.create(name: "power")
Intention.create(name: "pregnancy / childbirth")
Intention.create(name: "pride")
Intention.create(name: "prophecy")
Intention.create(name: "prosperity")
Intention.create(name: "protection")
Intention.create(name: "psychic ability")
Intention.create(name: "purification")
Intention.create(name: "purity")
Intention.create(name: "rebirth / renewal")
Intention.create(name: "reconciliation")
Intention.create(name: "relationships")
Intention.create(name: "respect")
Intention.create(name: "responsibility")
Intention.create(name: "revenge")
Intention.create(name: "reversal")
Intention.create(name: "romance")
Intention.create(name: "secrets")
Intention.create(name: "security")
Intention.create(name: "the senses")
Intention.create(name: "sensitivity")
Intention.create(name: "sensuality")
Intention.create(name: "sex/uality")
Intention.create(name: "shamanic work")
Intention.create(name: "shyness")
Intention.create(name: "skills")
Intention.create(name: "sleep")
Intention.create(name: "sorrow")
Intention.create(name: "spirits")
Intention.create(name: "spirituality")
Intention.create(name: "stability")
Intention.create(name: "stimulation")
Intention.create(name: "strength")
Intention.create(name: "stress")
Intention.create(name: "success")
Intention.create(name: "support")
Intention.create(name: "transformation")
Intention.create(name: "travel")
Intention.create(name: "trust")
Intention.create(name: "unity")
Intention.create(name: "truth")
Intention.create(name: "warmth")
Intention.create(name: "wealth")
Intention.create(name: "weather")
Intention.create(name: "well-being")
Intention.create(name: "willpower")
Intention.create(name: "wisdom")
Intention.create(name: "wishes")
Intention.create(name: "witches / witchcraft")
Intention.create(name: "youth")
Intention.create(name: "subconscious")
...
# Correspondence.create(name: " Bee", category_id: 24)
# Correspondence.create(name: "Devil", category_id: 27)
# Correspondence.create(name: "Yellow Green", category_id: 11)
# Correspondence.create(name: "Violet", category_id: 11)
# Correspondence.create(name: "Holly", category_id: 14)
# Correspondence.create(name: "Saffron", category_id: 13)
# Correspondence.create(name: "Peony", category_id: 15)
# Correspondence.create(name: "Vervain", category_id: 15)
# Correspondence.create(name: "Amethyst", category_id: 16)
# Correspondence.create(name: "Blue Lace Agate", category_id: 16)
# Correspondence.create(name: "Chrysocolla", category_id: 16)
# Correspondence.create(name: "Howlite", category_id: 16)
# Correspondence.create(name: "Sugilite", category_id: 16)
# Correspondence.create(name: "Sapphire", category_id: 16)
# Correspondence.create(name: "Topaz (blue)", category_id: 16)
# Correspondence.create(name: "Hera", category_id: 18)
# Correspondence.create(name: "Aegir", category_id: 19)
# Correspondence.create(name: "November", category_id: 5)
# Correspondence.create(name: "Mugwort ", category_id: 15)
# Correspondence.create(name: "Deer’s Tongue", category_id: 13)
# Correspondence.create(name: "Mullein", category_id: 13)
# Correspondence.create(name: "Agate (snakeskin)", category_id: 16)
# Correspondence.create(name: "Cat’s Eye", category_id: 16)
# Correspondence.create(name: "Hawk’s Eye", category_id: 16)
# Correspondence.create(name: "Jasper (leopard skin)", category_id: 16)
# Correspondence.create(name: "Labradorite", category_id: 16)
# Correspondence.create(name: "Diana", category_id: 18)
# Correspondence.create(name: "Juno", category_id: 18)
# Correspondence.create(name: "Maeve", category_id: 18)
# Correspondence.create(name: "Fairies", category_id: 25)
# Correspondence.create(name: "Pan", category_id: 19)
# Correspondence.create(name: "Dumuzi (shepherds)", category_id: 19)
# Correspondence.create(name: "Saturn", category_id: 19)
# Correspondence.create(name: "Pushan (guardian of cattle)", category_id: 19)
# Correspondence.create(name: "All", category_id: 20)
# Correspondence.create(name: "Lupercalia", category_id: 29)
# Correspondence.create(name: "Artemis", category_id: 18)
# Correspondence.create(name: "Ostara", category_id: 18)
# Correspondence.create(name: "Faunus", category_id: 19)
# Correspondence.create(name: "Khnum", category_id: 19)
# Correspondence.create(name: "Mabon", category_id: 19)
# Correspondence.create(name: "St. John’s Wort", category_id: 15)
# Correspondence.create(name: "Brigantia", category_id: 18)
# Correspondence.create(name: "Aspen", category_id: 14)
# Correspondence.create(name: "Birch", category_id: 14)
# Correspondence.create(name: "Mimosa", category_id: 14)
# Correspondence.create(name: "Witch Hazel", category_id: 14)
# Correspondence.create(name: "Columbine", category_id: 15)
# Correspondence.create(name: "Pennyroyal", category_id: 15)
# Correspondence.create(name: "Primrose", category_id: 15)
# Correspondence.create(name: "Betony", category_id: 13)
# Correspondence.create(name: "Frankincense", category_id: 13)
# Correspondence.create(name: "Aventurine (green)", category_id: 16)
# Correspondence.create(name: "Azurite", category_id: 16)
# Correspondence.create(name: "Kyanite", category_id: 16)
# Correspondence.create(name: "Smithsonite", category_id: 16)
# Correspondence.create(name: "Beech", category_id: 14)
# Correspondence.create(name: "Snapdragon", category_id: 15)
# Correspondence.create(name: "Asafoetida", category_id: 13)
# Correspondence.create(name: "Marduk", category_id: 19)
# Correspondence.create(name: "Mermaids", category_id: 25)
# Correspondence.create(name: "Panther", category_id: 20)
# Correspondence.create(name: "Leopard", category_id: 20)
# Correspondence.create(name: "Boar", category_id: 20)
# Correspondence.create(name: "Snake", category_id: 20)
# Correspondence.create(name: "Copperhead", category_id: 20)
# Correspondence.create(name: "Dittany", category_id: 13)
# Correspondence.create(name: "Belladonna", category_id: 13)
# Correspondence.create(name: "Cinnamon", category_id: 13)
# Correspondence.create(name: "Cinquefoil", category_id: 13)
# Correspondence.create(name: "Henbane", category_id: 13)
# Correspondence.create(name: "Ginger", category_id: 13)
# Correspondence.create(name: "Orris Root", category_id: 13)
# Correspondence.create(name: "Galangal", category_id: 13)
# Correspondence.create(name: "Mandrake", category_id: 13)
# Correspondence.create(name: "Thornapple", category_id: 13)
# Correspondence.create(name: "Comfrey", category_id: 15)
# Correspondence.create(name: "Mugwort", category_id: 15)
# Correspondence.create(name: "Rowan", category_id: 14)
# Correspondence.create(name: "Ash", category_id: 14)
# Correspondence.create(name: "Poplar", category_id: 14)
# Correspondence.create(name: "Blue", category_id: 11)
# Correspondence.create(name: "Silver", category_id: 11)
# Correspondence.create(name: "Heron (great blue)", category_id: 23)
# Correspondence.create(name: "Owl (long-eared)", category_id: 23)
# Correspondence.create(name: "Apophyllite", category_id: 16)
# Correspondence.create(name: "Ametrine", category_id: 16)
# Correspondence.create(name: "Calcite", category_id: 16)
# Correspondence.create(name: "Celestite", category_id: 16)
# Correspondence.create(name: "Cerussite", category_id: 16)
# Correspondence.create(name: "Jasper (red)", category_id: 16)
# Correspondence.create(name: "Moldovite", category_id: 16)
# Correspondence.create(name: "Quartz (clear", category_id: 16)
# Correspondence.create(name: "Staurolite", category_id: 16)
# Correspondence.create(name: "tourmalated)", category_id: 16)
# Correspondence.create(name: "Tourmaline (green)", category_id: 16)
# Correspondence.create(name: "Turquoise", category_id: 16)
# Correspondence.create(name: "Nut", category_id: 18)
# Correspondence.create(name: "Pele", category_id: 18)
# Correspondence.create(name: "Dryads", category_id: 25)
# Correspondence.create(name: "Manannan", category_id: 19)
# Correspondence.create(name: "Belenus", category_id: 19)
# Correspondence.create(name: "Lynx", category_id: 20)
...
# Correspondence.create(name: "Root", category_id: 12)
# Correspondence.create(name: "Pentacles", category_id: 27)
# Correspondence.create(name: "Blackberry", category_id: 15)
# Correspondence.create(name: "Brarrible", category_id: 15)
# Correspondence.create(name: "jasmine", category_id: 15)
# Correspondence.create(name: "Hawthorn", category_id: 14)
# Correspondence.create(name: "Raspberry", category_id: 15)
# Correspondence.create(name: "Bloodroot", category_id: 13)
# Correspondence.create(name: "Libra", category_id: 1)
# Correspondence.create(name: "Lovers", category_id: 27)
# Correspondence.create(name: "Elm", category_id: 14)
# Correspondence.create(name: "Magnolia", category_id: 14)
# Correspondence.create(name: "Linden", category_id: 14)
# Correspondence.create(name: "Palm (dragon's blood)", category_id: 14)
# Correspondence.create(name: "Allspice", category_id: 13)
# Correspondence.create(name: "Clove", category_id: 13)
# Correspondence.create(name: "Spikenard", category_id: 13)
# Correspondence.create(name: "High John", category_id: 13)
# Correspondence.create(name: "Vanilla", category_id: 13)
# Correspondence.create(name: "Lodestone", category_id: 16)
# Correspondence.create(name: "Anise", category_id: 13)
# Correspondence.create(name: "Flax", category_id: 13)
# Correspondence.create(name: "Lady’s Slipper", category_id: 13)
# Correspondence.create(name: "Nutmeg", category_id: 13)
# Correspondence.create(name: "Star Anise", category_id: 13)
# Correspondence.create(name: "Opal (black)", category_id: 16)
# Correspondence.create(name: "Aquamarine", category_id: 16)
# Correspondence.create(name: "Onyx", category_id: 16)
# Correspondence.create(name: "Sardonyx", category_id: 16)
# Correspondence.create(name: "Gold", category_id: 31)
# Correspondence.create(name: "Ea", category_id: 19)
# Correspondence.create(name: "Horus", category_id: 19)
# Correspondence.create(name: "Neptune", category_id: 19)
# Correspondence.create(name: "Njord", category_id: 19)
# Correspondence.create(name: "Odin", category_id: 19)
# Correspondence.create(name: "Festival of Luna", category_id: 29)
# Correspondence.create(name: "Indigo", category_id: 11)
# Correspondence.create(name: "Fir", category_id: 14)
# Correspondence.create(name: "Dandelion", category_id: 15)
# Correspondence.create(name: "Galangal Lady’s Slipper", category_id: 13)
# Correspondence.create(name: "Mushroom", category_id: 13)
# Correspondence.create(name: "Danburite", category_id: 16)
# Correspondence.create(name: "jasper (picture)", category_id: 16)
# Correspondence.create(name: "Obsidian (rainbow", category_id: 16)
# Correspondence.create(name: "snowflake)", category_id: 16)
# Correspondence.create(name: "Opal (black/cosmic)", category_id: 16)
# Correspondence.create(name: "yellow)", category_id: 16)
# Correspondence.create(name: "Cockle", category_id: 17)
# Correspondence.create(name: "Conch", category_id: 17)
# Correspondence.create(name: "Sand Dollar", category_id: 17)
# page 28 awareness continued
 puts "Seeded."

#  Intention.create(name: "abundance", desc: "to attract, perpetuate")